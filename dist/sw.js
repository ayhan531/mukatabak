    ...
    event.respondWith((async () => {
      try {
        ...
        return (await kutu.match("/"))
          ...
          || new Response("<!doctype html><meta charset=utf-8><title>Mukatabak</title><p>Çevrimdışısınız.", {
      ...
      try {
        ...
        if (hazir) {
          ...
          return new Response(govde, {
            status: 200,
            headers: { "Content-Type": "application/json; charset=utf-8", "X-Mukatabak-Cache": "1" },
          });
        }
...
self.addEventListener("push", (event) => {
  event.waitUntil((async () => {
    let baslik = "Mukatabak Yatırım";
    let govde = "Yeni bir bildiriminiz var.";
    let etiket = "mukatabak";
