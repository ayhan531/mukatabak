...
try:
    ...
    kod, veri = iste("/api/admin/create-user", {
        ...
        "email": "sil@mukatabak.local", "password": "Mukatabak12345a", "status": "approved", "opening_balance": 500,
    })
    ...
    kod, veri = iste("/api/admin/create-user", {
        ...
        "email": "yeni@mukatabak.local", "password": "Mukatabak12345a", "status": "approved",
    })
